...
<Tip>
This is the recommended mode for most applications, including [multi-agent](/oss/javascript/langchain/multi-agent) systems where subagents are invoked as tools. It supports interrupts and multiple subgraphs while keeping each invocation isolated.
</Tip>
